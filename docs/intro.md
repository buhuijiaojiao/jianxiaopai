...
slug: /
sidebar_position: 1
description: 简小派（JianXiaoPai）新版文档中心，提供一站式求职、智能决策与AI陪跑等核心功能的全面说明。
keywords: [简小派, JianXiaoPai, 求职, 文档, AI求职助手, 面试模拟]
---
...
:::
> ⚠️ 当前文档内容正在逐步完善中，部分章节尚未开放，敬请期待后续更新。
...
- 📘 **文档中心**：[https://docs.jianlipai.com](https://docs.jianlipai.com)
...
<div style={{
  ...
  <img src="/img/screenshot/screenshot1.png" width="90%" alt="预览1" />
  <img src="/img/screenshot/screenshot2.png" width="90%" alt="预览2" />
  <img src="/img/screenshot/screenshot3.png" width="90%" alt="预览3" />
  <img src="/img/screenshot/screenshot4.png" width="90%" alt="预览4" />
  <img src="/img/screenshot/screenshot5.png" width="90%" alt="预览5" />
</div>
